...
insert into user(us_name,us_email) values("Anu","anu@gmail.com");
...
insert into attempt(at_date,at_us_id,at_score) values("2021-02-02",1,3.5);
...
insert into attempt_option(ao_op_id,ao_aq_id,ao_selected) values(6,2,0);
insert into attempt_option(ao_op_id,ao_aq_id,ao_selected) values(7,2,0);
insert into attempt_option(ao_op_id,ao_aq_id,ao_selected) values(8,2,1);
